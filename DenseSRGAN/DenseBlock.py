...
def dense_comp_fn(x, idx, layer_idx, num_filters,
    ...
    x = Conv2D(feat_maps, (1, 1), name=name_base +
               '_btlnck_conv', use_bias=False)(x)
    if dropout_rate:
...
def dense_block(x, idx, num_layers, num_filters,
    ...
    ''' Dense Block with num_layers and num_filters from DenseNet paper
        # Arguments
          ...
          num_layers: the number of layers of conv_block
